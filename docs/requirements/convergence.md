...
| CR-8.3 | Each reviewer has a numeric priority rank: truthfulness (80) > ATS (60) > grammar (50) > voice (40) > AI (30) > HM (20) > pruning (10). |
...
| CR-8.9 | The `repair_unified` method determines the dominant reviewer by checking all reviewers in priority order (truthfulness > ATS > grammar > voice > AI) and tags all edits and edit regions with that reviewer's priority. |
